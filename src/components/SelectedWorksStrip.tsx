...
export function SelectedWorksStrip({ onWorkClick }: SelectedWorksStripProps) {
  ...
  const duplicatedWorks = hasWorks
  ...
  const animate = useCallback(() => {
    ...
    if (!isPaused) {
      ...
      if (singleSetWidth > 0 && scrollPos.current >= singleSetWidth) {
            ...
            >
              {duplicatedWorks.map((item, i) => {
                ...
                return (
                  ...
                  >
                    <div className="glass-card rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-xl">
